...
\begin{figure}[thb]
	\centering
		\includegraphics[width=0.45\textwidth]{figures/example.jpg}
    	\captionsource[The same cat]{This is the same \ac{RT} cat. Note the
    	additional field for the source.}{http://bgp.potaroo.net.}
	\label{fig:fig3}
\end{figure}

Duis malesuada ultrices rutrum. In posuere sem dapibus urna accumsan id
